...
import edu.umd.navU.core.buildings.csic.FirstFloor;
import edu.umd.navU.core.buildings.csic.SecondFloor;
import edu.umd.navU.core.buildings.csic.ThirdFloor;
import edu.umd.navU.core.dijkstra.engine.DijkstraAlgorithm;
import edu.umd.navU.core.dijkstra.model.Edge;
import edu.umd.navU.core.dijkstra.model.Graph;
...
public class Driver {
    ...
    private static LinkedList<Vertex> findPath(String origin, String destination) {
        ...
        try {
            switch (originFloor) {
                case '1':
                    clazz = Class.forName("edu.umd.navU.core.buildings.csic.FirstFloor");
                    break;
                case '2':
                    clazz = Class.forName("edu.umd.navU.core.buildings.csic.SecondFloor");
                    break;
                case '3':
                    clazz = Class.forName("edu.umd.navU.core.buildings.csic.ThirdFloor");
                    break;
                default:
